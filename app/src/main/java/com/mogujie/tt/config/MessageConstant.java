...
public interface MessageConstant {
    ...
    /**紅包消息的前后常量*/
    public  final String HONGBAO_MSG_START = "&&$#@~^$[{:";
    public  final String HONGBAO_MSG_END = "&:}]&$~$#@";

    /**紅包确认消息的前后常量*/
    public  final String HONGBAO_MSG_ACK_START = "&$$#@~^$[{$";
    public  final String HONGBAO_MSG_ACK_END = "&$}]&$~$$@";


    /**红包状态，未读与已读*/
    public final int   HONGBAO_UNREAD =1;
    public final int   HONGBAO_READED = 2;
