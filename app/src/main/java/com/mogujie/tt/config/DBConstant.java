...
public interface DBConstant {
    ...
    public final int SHOW_HONGBAO_TYPE = 6;
    public final int SHOW_HONGBAO_ACK_TYPE = 7;
    ...
    public final String DISPLAY_FOR_HONGBAO = "[红包]";
    public final String DISPLAY_FOR_HONGBAO_ACK = "[红包确认]";
