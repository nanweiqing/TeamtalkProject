...
public class UserDao extends AbstractDao<UserEntity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property SignInfo = new Property(13,String.class,"signInfo",false,"SIGN_INFO");
    };
    ...
    public UserEntity readEntity(Cursor cursor, int offset) {
        UserEntity entity = new UserEntity( //
            ...
            cursor.getString(offset + 13) // signInfo
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, UserEntity entity, int offset) {
        ...
        entity.setSignInfo(cursor.getString(offset + 13));
     }
